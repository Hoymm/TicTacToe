...
|:---:|:---:|:---:|:---:|
|25.04|Mantra, Git, nauczenie się podstaw TestNG, Gra wyświetla (przykładowe) graczy i punktacje| + Wyświetla przykładową planszę 3x3| + Umożliwia postawienie znaków na planszy
